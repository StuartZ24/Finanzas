...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="home.html">Entradas/Salidas</a>
            <!-- Sidebar Toggle-->
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="d-flex justify-content-end pb-4" >
                            <a class="btn btn-primary" href="salidasCreate.html" role="button">Agregar Salidas</a>
                        </div>
                        <div class="card mb-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group me-2" role="group" aria-label="First group">
                                                    <a class="btn btn-warning" href="salidasEdit.html" role="button"><i class="fa-solid fa-pen-to-square"></i> Editar</a>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Entradas/Salidas 2022</div>
                        </div>
                    </div>
                </footer>
            </div>
