...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <!-- Background Video -->
        <img class="bg-video" src="{{ asset('img/pexels-photo-3806749.jpeg') }}" alt="Fondo" />
        <!-- Masthead-->
        <div class="masthead">
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    ...
                    <div class="row input-group-newsletter">
                      <div class="col-auto"><a class="btn btn-primary button" id="submitButton" href="{{ url('/login') }}" role="button">Ingresar!</a></div>
                    </div>
                </div>
            </div>
        </div>
